...
The workflow will create a pull request with all the changes against your dev branch. Review and approve it to commit the files to deploy CI/CD for the project. 
