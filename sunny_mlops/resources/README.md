...
| staging     | The `staging` deployment target is part of the CD pipeline. Latest dev content will be deployed to staging workspace with `staging` config.                                                             | staging workspace    | staging-sunny_mlops-model | /staging-sunny_mlops-experiment |
